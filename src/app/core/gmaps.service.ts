...
export class GoogleMapsService {
  ...
  public geocodeAddress(address: string, postalCode?: string, place?: string, province?: string, region?: string, country?: string): Observable<any> {
  ...
  public getStaticMapUrl(latitude: number, longitude: number, zoom = 12, width = 400, height = 400) {
    return `${this.API_URL}/staticmap?center=${latitude},${longitude}&zoom=${zoom}&size=${width}x${height}&key=${this.API_KEY}`
